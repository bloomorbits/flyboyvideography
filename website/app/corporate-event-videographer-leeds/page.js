...
export default async function CorporateEventVideographerLeedsPage() {
  const heroVideo = await getCategoryHeroVideo("corporate");
  return <SEOLandingPage {...CONTENT} heroVideo={heroVideo} heroLabel="Corporate" />;
}
