...
const SLUG = "/naming-ceremony-videographer-sheffield";
const TITLE = "Naming Ceremony Videographer Sheffield | Flyboy Videography";
const DESCRIPTION =
  "Naming ceremony and cultural celebration videography in Sheffield and South Yorkshire. From £200 — honest pricing, cinematic delivery, and real understanding of what your day means.";
...
const CONTENT = {
  ...
  h1: "Naming Ceremony Videographer Sheffield",
  directAnswer:
    "Flyboy Videography films naming ceremonies, gender reveals, and cultural celebrations across Sheffield and South Yorkshire, with packages from £200 for 2 hours of coverage up to £450 for full celebrations. We understand the significance of these moments within West African and wider diaspora traditions, and we film them with that understanding, not as generic event coverage.",
  body: [
  ...
  faqs: [
    {
      q: "How much does a naming ceremony videographer cost in Sheffield?",
...
export default async function NamingCeremonyVideographerSheffieldPage() {
  const heroVideo = await getCategoryHeroVideo("naming");
  return <SEOLandingPage {...CONTENT} heroVideo={heroVideo} heroLabel="Naming Ceremony" />;
}
